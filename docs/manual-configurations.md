...
| Full sample bio (name, CHARUSAT, B.Tech CS) | `frontend/template-map.html:173,195` | This is **real personal content**, not a generic placeholder — a new developer who doesn't replace it before sending will email a stranger's real biography to recruiters as if it were their own. |
